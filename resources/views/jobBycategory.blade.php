...
<x-header-footer>
    ...
    <section id="jobsByCategory" class="section-3 bg-2 py-5">
        <div class="container">
            <h2><u><b><i>job category : {{$category_name}}</i></b></u></h2>
                    ...
                    @foreach($jobs as $job)
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="card p-4 shadow-sm h-100 d-flex flex-column" style="height: 400px; overflow: hidden;">
                                <h4 class="mb-2"><b>{{ $job->jobTitle->job_title ?? 'No Title' }}</b></h4><hr>
                                <p class="mb-1">
