                ...
                <ul class="navbar-nav ms-auto">
                    @auth
                        @if(Auth::user()->role == 'employer')
                            <li class="nav-item me-2">
                                <a class="btn btn-outline-primary text-white" href="{{ route('postJob') }}">Post a Job</a>
                            </li>
                        @endif
                    ...
                    @else
                        <li class="nav-item dropdown me-2">
                            <a class="btn btn-outline-primary dropdown-toggle text-white" href="#" role="button"
