                ...
                <div class="col">
                    <nav aria-label="breadcrumb" class="rounded-3 p-3 mb-4">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active"><b>Educations</b></li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-lg-9">
                    ...
                    <div class="card border-0 shadow mb-4">
                        <div class="card-body p-4">
                            <h4 class="fs-4 mb-4"><u>Education :</u></h4>

                            {{-- Show existing education --}}
                            @if(!empty($education))
                                <div class="mb-4">
                                    <h3 id="educationText" class="fs-4 mb-4">{{ $educations->educations }}</h3>
                            ...
                            <form action="{{ route('add-cv-data') }}" method="POST" id="editForm" style="display: none; margin-top: 30px;">
                                ...
                                <div class="mb-4">
                                    <label for="education" class="form-label">Update Education</label>
                                    <textarea name="education" id="education" class="form-control" rows="4" placeholder="write about your education." required>{{ old('educations', $educations->educations?? '') }}</textarea>
                                </div>
